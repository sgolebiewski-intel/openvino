...
.. parsed-literal::
  ...
  0%|          | 296k/138M [00:00<00:49, 2.91MB/s]

.. parsed-literal::

    
  2%|▏         | 2.49M/138M [00:00<00:09, 14.6MB/s]

.. parsed-literal::

    
  8%|▊         | 11.7M/138M [00:00<00:02, 50.9MB/s]

.. parsed-literal::

    
 12%|█▏        | 16.5M/138M [00:00<00:03, 42.5MB/s]

.. parsed-literal::

    
 20%|██        | 27.7M/138M [00:00<00:01, 66.3MB/s]

.. parsed-literal::

    
 27%|██▋       | 36.6M/138M [00:00<00:01, 74.8MB/s]

.. parsed-literal::

    
 34%|███▍      | 47.2M/138M [00:00<00:01, 85.8MB/s]

.. parsed-literal::

    
 42%|████▏     | 58.4M/138M [00:00<00:00, 95.3MB/s]

.. parsed-literal::

    
 49%|████▉     | 67.7M/138M [00:00<00:00, 86.3MB/s]

.. parsed-literal::

    
 55%|█████▌    | 76.2M/138M [00:01<00:00, 86.8MB/s]

.. parsed-literal::

    
 61%|██████▏   | 84.7M/138M [00:01<00:00, 79.2MB/s]

.. parsed-literal::

    
 67%|██████▋   | 92.5M/138M [00:01<00:00, 74.5MB/s]

.. parsed-literal::

    
 72%|███████▏  | 99.8M/138M [00:01<00:00, 73.2MB/s]

.. parsed-literal::

    
 77%|███████▋  | 107M/138M [00:01<00:00, 71.7MB/s] 

.. parsed-literal::

    
 82%|████████▏ | 114M/138M [00:01<00:00, 70.7MB/s]

.. parsed-literal::

    
 87%|████████▋ | 121M/138M [00:01<00:00, 70.5MB/s]

.. parsed-literal::

    
 92%|█████████▏| 127M/138M [00:01<00:00, 70.0MB/s]

.. parsed-literal::

    
 97%|█████████▋| 134M/138M [00:02<00:00, 60.3MB/s]

.. parsed-literal::

    
100%|██████████| 138M/138M [00:02<00:00, 69.0MB/s]
...
.. parsed-literal::
    ...
    image 1/1 /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-633/.workspace/scm/ov-notebook/notebooks/261-fast-segment-anything/coco_bike.jpg: 768x1024 37 objects, 615.8ms


.. parsed-literal::

    Speed: 3.8ms preprocess, 615.8ms inference, 27.0ms postprocess per image at shape (1, 3, 768, 1024)
...
.. parsed-literal::
    ...
    Ultralytics YOLOv8.0.200 🚀 Python-3.8.10 torch-2.2.1+cpu CPU (Intel Core(TM) i9-10920X 3.50GHz)
...
.. parsed-literal::
    ...
    ONNX: export success ✅ 3.7s, saved as 'FastSAM-x.onnx' (275.5 MB)
...
.. parsed-literal::
    ...
    Results saved to /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-633/.workspace/scm/ov-notebook/notebooks/261-fast-segment-anything
...
.. parsed-literal::
    ...
    image 1/1 /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-633/.workspace/scm/ov-notebook/notebooks/261-fast-segment-anything/coco_bike.jpg: 480x640 33 objects, 298.8ms


.. parsed-literal::

    Speed: 2.3ms preprocess, 298.8ms inference, 27.2ms postprocess per image at shape (1, 3, 480, 640)
