...
.. parsed-literal::
    ...
    image 1/1 /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-632/.workspace/scm/ov-notebook/notebooks/261-fast-segment-anything/coco_bike.jpg: 768x1024 37 objects, 617.2ms


.. parsed-literal::

    Speed: 3.0ms preprocess, 617.2ms inference, 27.3ms postprocess per image at shape (1, 3, 768, 1024)
...
.. parsed-literal::
    ...
    ONNX: export success ✅ 3.6s, saved as 'FastSAM-x.onnx' (275.5 MB)
...
.. parsed-literal::
    ...
    Results saved to /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-632/.workspace/scm/ov-notebook/notebooks/261-fast-segment-anything
