...
.. parsed-literal::
    ...
    [23:24:24.3420]I[plugin.cpp:418][AUTO] device:CPU, config:LOG_LEVEL=LOG_INFO
    [23:24:24.3420]I[plugin.cpp:418][AUTO] device:CPU, config:PERFORMANCE_HINT=LATENCY
    [23:24:24.3421]I[plugin.cpp:418][AUTO] device:CPU, config:PERFORMANCE_HINT_NUM_REQUESTS=0
    [23:24:24.3421]I[plugin.cpp:418][AUTO] device:CPU, config:PERF_COUNT=NO
    [23:24:24.3421]I[plugin.cpp:423][AUTO] device:CPU, priority:0
    [23:24:24.3421]I[schedule.cpp:17][AUTO] scheduler starting
    [23:24:24.3422]I[auto_schedule.cpp:131][AUTO] select device:CPU
    [23:24:24.5021]I[auto_schedule.cpp:109][AUTO] device:CPU compiling model finished
    [23:24:24.5023]I[plugin.cpp:451][AUTO] underlying hardware does not support hardware context
...
.. parsed-literal::
    ...
    Deleted compiled_model[23:24:24.5134]I[schedule.cpp:303][AUTO] scheduler ending
...
.. parsed-literal::
    ...
    throughput:  179.56fps, latency:  31.74ms, time interval: 10.01s
    throughput:  178.79fps, latency:  32.74ms, time interval: 10.02s
    throughput:  180.23fps, latency:  32.53ms, time interval: 10.00s
    throughput:  178.76fps, latency:  32.71ms, time interval: 10.00s
    throughput:  179.37fps, latency:  32.64ms, time interval: 10.01s
    throughput:  178.91fps, latency:  32.73ms, time interval: 10.01s
    Done
...
.. parsed-literal::
    ...
    throughput:  135.09fps, latency:  6.82ms, time interval: 10.00s
    throughput:  137.87fps, latency:  6.81ms, time interval: 10.00s
    throughput:  137.87fps, latency:  6.81ms, time interval: 10.00s
    throughput:  137.96fps, latency:  6.81ms, time interval: 10.00s
    throughput:  137.76fps, latency:  6.82ms, time interval: 10.00s
    throughput:  137.80fps, latency:  6.82ms, time interval: 10.00s
    Done
