...
.. image:: 286-instant-id-with-output_files/286-instant-id-with-output_15_0.png
...
.. image:: 286-instant-id-with-output_files/286-instant-id-with-output_16_0.png
...
for
`details <248-stable-diffusion-xl-with-output.html>`__),
now we will use it in combination with ControlNet and convert it using
...
-  Image Projection model for getting image prompt embeddings. It is
   ...
   tutorial <278-stable-diffusion-ip-adapter-with-output.html>`__,
...
.. image:: 286-instant-id-with-output_files/286-instant-id-with-output_41_0.png
...
.. image:: 286-instant-id-with-output_files/286-instant-id-with-output_66_0.png
