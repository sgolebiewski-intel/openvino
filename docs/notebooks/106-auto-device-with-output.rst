...
.. parsed-literal::
    ...
    [22:23:22.8287]I[plugin.cpp:418][AUTO] device:CPU, config:LOG_LEVEL=LOG_INFO
    [22:23:22.8288]I[plugin.cpp:418][AUTO] device:CPU, config:PERFORMANCE_HINT=LATENCY
    [22:23:22.8288]I[plugin.cpp:418][AUTO] device:CPU, config:PERFORMANCE_HINT_NUM_REQUESTS=0
    [22:23:22.8288]I[plugin.cpp:418][AUTO] device:CPU, config:PERF_COUNT=NO
    [22:23:22.8288]I[plugin.cpp:423][AUTO] device:CPU, priority:0
    [22:23:22.8288]I[schedule.cpp:17][AUTO] scheduler starting
    [22:23:22.8288]I[auto_schedule.cpp:131][AUTO] select device:CPU
    [22:23:22.9663]I[auto_schedule.cpp:109][AUTO] device:CPU compiling model finished
    [22:23:22.9664]I[plugin.cpp:451][AUTO] underlying hardware does not support hardware context
...
.. parsed-literal::
    ...
    [22:23:22.9726]I[schedule.cpp:303][AUTO] scheduler ending
...
.. parsed-literal::
    ...
    throughput:  182.05fps, latency:  31.24ms, time interval: 10.01s


.. parsed-literal::

    throughput:  183.30fps, latency:  31.91ms, time interval: 10.00s


.. parsed-literal::

    throughput:  182.58fps, latency:  32.15ms, time interval: 10.00s


.. parsed-literal::

    throughput:  181.48fps, latency:  32.29ms, time interval: 10.00s


.. parsed-literal::

    throughput:  180.93fps, latency:  32.32ms, time interval: 10.00s


.. parsed-literal::

    throughput:  182.26fps, latency:  32.16ms, time interval: 10.00s
...
.. parsed-literal::
    ...
    throughput:  139.74fps, latency:  6.64ms, time interval: 10.00s


.. parsed-literal::

    throughput:  142.72fps, latency:  6.64ms, time interval: 10.01s


.. parsed-literal::

    throughput:  142.73fps, latency:  6.63ms, time interval: 10.01s


.. parsed-literal::

    throughput:  141.54fps, latency:  6.64ms, time interval: 10.00s


.. parsed-literal::

    throughput:  142.50fps, latency:  6.62ms, time interval: 10.01s


.. parsed-literal::

    throughput:  142.44fps, latency:  6.62ms, time interval: 10.00s
