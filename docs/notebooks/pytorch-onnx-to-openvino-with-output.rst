...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.040 seconds per image, FPS: 25.11
    ONNX model in OpenVINO Runtime/AUTO: 0.019 seconds per image, FPS: 53.83
    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 35.38
