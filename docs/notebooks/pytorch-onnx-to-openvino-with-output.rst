...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.041 seconds per image, FPS: 24.43
    ONNX model in OpenVINO Runtime/AUTO: 0.019 seconds per image, FPS: 53.99
    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 35.23
