...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.039 seconds per image, FPS: 25.39
    ONNX model in OpenVINO Runtime/AUTO: 0.030 seconds per image, FPS: 33.59
    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 35.59
