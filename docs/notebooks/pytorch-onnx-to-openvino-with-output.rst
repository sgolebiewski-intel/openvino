...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.040 seconds per image, FPS: 25.01


.. parsed-literal::

    ONNX model in OpenVINO Runtime/AUTO: 0.029 seconds per image, FPS: 34.08


.. parsed-literal::

    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 35.53
