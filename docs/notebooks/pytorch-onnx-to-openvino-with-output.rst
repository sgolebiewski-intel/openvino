...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.037 seconds per image, FPS: 26.70


.. parsed-literal::

    ONNX model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 36.36


.. parsed-literal::

    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.028 seconds per image, FPS: 35.92
