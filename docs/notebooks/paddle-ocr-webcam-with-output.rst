...
.. code:: ipython3
    ...
    if not utils_file_path.exists():
        ...
        notebook_directory_path = Path('./openvino_notebooks/notebooks/paddle-ocr-webcam/')
...
.. parsed-literal::
    ...
    /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-644/.workspace/scm/ov-notebook/notebooks/paddle-o…
