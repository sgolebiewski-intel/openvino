...
.. code:: ipython3
    ...
    %pip install -q "diffusers>=0.14.0" "openvino>=2023.1.0" "datasets>=2.14.6" "transformers>=4.25.1" gradio "torch>=2.1" --extra-index-url https://download.pytorch.org/whl/cpu
