...
.. parsed-literal::
    ...
    2024-03-13 23:28:10.293639: I tensorflow/core/util/port.cc:110] oneDNN custom operations are on. You may see slightly different numerical results due to floating-point round-off errors from different computation orders. To turn them off, set the environment variable `TF_ENABLE_ONEDNN_OPTS=0`.
    2024-03-13 23:28:10.326400: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
    To enable the following instructions: AVX2 AVX512F AVX512_VNNI FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.


.. parsed-literal::

    2024-03-13 23:28:10.898205: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
.. parsed-literal::
    ...
    PersonaGPT: hi! great, thanks for asking. how are you?


.. parsed-literal::

    Person: What are you doing?
    PersonaGPT: i am studying for exams and am working on homework


.. parsed-literal::

    Person: I like to dance,do you?
    PersonaGPT: i am not much of a dance fan. i'm more of a music fan than a sporty person


.. parsed-literal::

    Person: Can you recommend me some books?
    PersonaGPT: any of george carlin books, mostly. i also love his autobiographies


.. parsed-literal::

    Person: Hi,How are you?
    PersonaGPT: what do you do for a living?


.. parsed-literal::

    Person: What are you doing?
    PersonaGPT: i'm currently unemployed.


.. parsed-literal::

    Person: I like to dance,do you?
    PersonaGPT: i like to dance to some of his autobiographies.


.. parsed-literal::

    Person: Can you recommend me some books?
    PersonaGPT: do you have any hobbies?


.. parsed-literal::

    Person: Hi,How are you?
    PersonaGPT: i am fine what about you?


.. parsed-literal::

    Person: What are you doing?
    PersonaGPT: i'm working on some homework
