...
.. parsed-literal::
    ...
    /tmp/ipykernel_2131390/2434168836.py:12: UserWarning: No data for colormapping provided via 'c'. Parameters 'cmap' will be ignored
      ax.scatter3D(X, Y, Z, s=5, cmap="jet", marker="o", label="chair")
...
.. parsed-literal::
    ...
    /tmp/ipykernel_2131390/2804603389.py:23: UserWarning: No data for colormapping provided via 'c'. Parameters 'cmap' will be ignored
      ax.scatter(XCur, YCur, ZCur, s=5, cmap="jet", marker="o", label=classes[i])
