...
.. parsed-literal::
    ...
    <DisplayHandle display_id=8d3b613d1eb0c70a883515b837d7d287>
...
.. parsed-literal::
    ...
    PyTorch model on CPU. First inference time: 0.0211 seconds


.. parsed-literal::

    PyTorch model on CPU: 0.0199 seconds per image (50.28 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU: 0.0070 seconds per image (142.56 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + bigger batch on CPU: 0.0068 seconds per image (147.82 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU (THROUGHPUT). First inference time: 0.0268 seconds


.. parsed-literal::

    OpenVINO model on CPU (THROUGHPUT): 0.0040 seconds per image (249.30 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO (THROUGHPUT). First inference time: 0.0195 seconds


.. parsed-literal::

    OpenVINO model on AUTO (THROUGHPUT): 0.0040 seconds per image (249.66 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO (CUMULATIVE THROUGHPUT). First inference time: 0.0252 seconds


.. parsed-literal::

    OpenVINO model on AUTO (CUMULATIVE THROUGHPUT): 0.0040 seconds per image (248.91 FPS)
