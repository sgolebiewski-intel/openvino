...
.. parsed-literal::
    ...
    To disable this warning, you can either:
    	- Avoid using `tokenizers` before the fork if possible
    	- Explicitly set the environment variable TOKENIZERS_PARALLELISM=(true | false)
    2024-05-28 00:25:43.128021: I tensorflow/core/util/port.cc:110] oneDNN custom operations are on. You may see slightly different numerical results due to floating-point round-off errors from different computation orders. To turn them off, set the environment variable `TF_ENABLE_ONEDNN_OPTS=0`.
    2024-05-28 00:25:43.163343: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
    To enable the following instructions: AVX2 AVX512F AVX512_VNNI FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.
    2024-05-28 00:25:43.784767: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
.. parsed-literal::
    ...
    2024-05-28 00:25:56.501621: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
    ...
    Optional arguments:
      --task TASK           The task to export the model for. If not specified,
                            ...
                            ['image-segmentation', 'text-classification', 'text-
                            to-audio', 'image-classification', 'sentence-
                            similarity', 'conversational', 'masked-im', 'audio-
                            frame-classification', 'multiple-choice', 'image-to-
                            image', 'question-answering', 'audio-xvector',
                            'feature-extraction', 'token-classification', 'depth-
                            estimation', 'zero-shot-object-detection', 'automatic-
                            speech-recognition', 'mask-generation', 'text2text-
                            generation', 'stable-diffusion', 'stable-diffusion-
                            xl', 'text-generation', 'semantic-segmentation',
                            'image-to-text', 'zero-shot-image-classification',
                            'audio-classification', 'object-detection', 'fill-
                            mask']. For decoder models, use `xxx-with-past` to
...
.. parsed-literal::
    ...
    2024-05-28 00:26:01.247756: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
    INFO:nncf:NNCF initialized successfully. Supported frameworks detected: torch, tensorflow, onnx, openvino
    /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-690/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/diffusers/utils/outputs.py:63: UserWarning: torch.utils._pytree._register_pytree_node is deprecated. Please use torch.utils._pytree.register_pytree_node instead.
      torch.utils._pytree._register_pytree_node(
