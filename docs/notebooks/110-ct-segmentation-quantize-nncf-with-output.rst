...
.. parsed-literal::
    ...
    2024-03-13 22:35:15.469873: I tensorflow/core/util/port.cc:110] oneDNN custom operations are on. You may see slightly different numerical results due to floating-point round-off errors from different computation orders. To turn them off, set the environment variable `TF_ENABLE_ONEDNN_OPTS=0`.
    2024-03-13 22:35:15.503975: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
    To enable the following instructions: AVX2 AVX512F AVX512_VNNI FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.


.. parsed-literal::

    2024-03-13 22:35:16.069786: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
.. parsed-literal::
    ...
    Mismatched elements: 246945 / 262144 (94.2%)
    Greatest absolute difference: 3.10476016998291 at index (0, 0, 78, 303) (up to 1e-05 allowed)
    Greatest relative difference: 2208.6611135174435 at index (0, 0, 62, 450) (up to 1e-05 allowed)
      _check_trace(
...
.. parsed-literal::
    ...
    [ INFO ] Compile model took 143.82 ms
    ...
    Traceback (most recent call last):
      File "/opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-633/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/openvino/tools/benchmark/main.py", line 486, in main
        data_queue = get_input_data(paths_to_input, app_inputs_info)
      File "/opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-633/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/openvino/tools/benchmark/utils/inputs_filling.py", line 123, in get_input_data
...
.. parsed-literal::
    ...
    [ INFO ] Compile model took 233.56 ms
    [Step 8/11] Querying optimal runtime parameters
    [ INFO ] Model:
...
.. parsed-literal::
    ...
    [ INFO ] First inference took 27.49 ms
...
.. parsed-literal::
    ...
    [ INFO ] Duration:         15006.09 ms
    [ INFO ] Latency:
    [ INFO ]    Median:        15.23 ms
    [ INFO ]    Average:       15.29 ms
    [ INFO ]    Min:           15.00 ms
    [ INFO ]    Max:           18.69 ms
    [ INFO ] Throughput:   64.57 FPS
...
.. parsed-literal::
    ...
    Visualizing results with seed 1710365779
...
.. parsed-literal::
    ...
    Total time for 68 frames: 2.63 seconds, fps:26.21
