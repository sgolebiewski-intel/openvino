...
.. parsed-literal::
    ...
    PyTorch model on CPU: 0.040 seconds per image, FPS: 24.98


.. parsed-literal::

    ONNX model in OpenVINO Runtime/AUTO: 0.018 seconds per image, FPS: 54.76


.. parsed-literal::

    OpenVINO IR model in OpenVINO Runtime/AUTO: 0.029 seconds per image, FPS: 34.72
