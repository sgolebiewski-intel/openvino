...
.. parsed-literal::
    ...
    <DisplayHandle display_id=b6533de15c5abd23995939afe5aaabc8>
...
.. parsed-literal::
  ...
  8%|▊         | 304k/3.87M [00:00<00:01, 3.06MB/s]

.. parsed-literal::

    
 63%|██████▎   | 2.45M/3.87M [00:00<00:00, 14.4MB/s]
...
.. parsed-literal::
    ...
    PyTorch model on CPU. First inference time: 0.0301 seconds


.. parsed-literal::

    PyTorch model on CPU: 0.0215 seconds per image (46.54 FPS)
...
.. parsed-literal::
    ...
    ONNX model on CPU: 0.0123 seconds per image (81.13 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU. First inference time: 0.0185 seconds


.. parsed-literal::

    OpenVINO model on CPU: 0.0120 seconds per image (83.09 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + more threads on CPU. First inference time: 0.0149 seconds


.. parsed-literal::

    OpenVINO model + more threads on CPU: 0.0121 seconds per image (82.67 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO: 0.0123 seconds per image (81.12 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + shared memory on AUTO. First inference time: 0.0129 seconds


.. parsed-literal::

    OpenVINO model + shared memory on AUTO: 0.0054 seconds per image (185.99 FPS)
