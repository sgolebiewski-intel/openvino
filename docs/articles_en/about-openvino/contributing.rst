...
Address only the issues that affect the master
or :doc:`LTS release branches <./release-notes-openvino/release-policy>`.
...
(PR) addressing it. If you find a new bug and want to fix it, you should still
...
with OpenVINO developers first. If you have an idea for a new feature and want
...
`guide <https://github.com/openvinotoolkit/openvino/blob/master/CONTRIBUTING_DOCS.md>`__ a
nd contacting `documentation maintainers <https://github.com/orgs/openvinotoolkit/teams/openvino-docs-maintainers>`__,
...
contribution. You can also contact documentation maintainers, if you need help
with visuals, brand materials, or content creation in general.
...
.. note::
   ...
   By contributing to the OpenVINO project, you agree that your contributions will be licensed under `the terms of the OpenVINO repository <https://github.com/openvinotoolkit/openvino/blob/master/LICENSE>`__.
