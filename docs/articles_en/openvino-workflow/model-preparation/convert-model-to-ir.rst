      ...
      .. tab-set::
         ...
         .. tab-item:: Python
            ...
            * The ``convert_model()`` method:
              ...
              and an example `tutorial <https://github.com/openvinotoolkit/openvino_notebooks/blob/master/notebooks/pytorch-to-openvino/pytorch-onnx-to-openvino.ipynb>`__
              on this topic.
      ...
      .. tab-set::
         ...
         .. tab-item:: Python
            ...
            * The ``convert_model()`` method:
              ...
              and an example `tutorial <https://github.com/openvinotoolkit/openvino_notebooks/blob/master/notebooks/tflite-to-openvino/tflite-to-openvino.ipynb>`__
              on this topic.
      ...
      .. tab-set::
         ...
         .. tab-item:: Python
            ...
            * The ``convert_model()`` method:
              ...
              and an example `tutorial <https://github.com/openvinotoolkit/openvino_notebooks/blob/master/notebooks/paddle-to-openvino/paddle-to-openvino-classification.ipynb>`__
              on this topic.
