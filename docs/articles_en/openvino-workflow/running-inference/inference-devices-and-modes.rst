...
|    Defines just one device responsible for the entire inference workload. It supports a range of
...
|    Introduces certain level of automation in selecting devices for inference. It may potentially
     increase performance and portability of your deployed solution. The automated modes are:
...
The output you receive may be truncated to device names only:
