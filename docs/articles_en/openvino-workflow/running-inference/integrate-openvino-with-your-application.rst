...
.. tab-set::
    ...
    .. tab-item:: Python
       ...
       .. doxygensnippet:: docs/articles_en/assets/snippets/src/main.py
          :language: python
          :fragment: [import]
    ...
    .. tab-item:: C++
       ...
       .. doxygensnippet:: docs/articles_en/assets/snippets/src/main.cpp
          :language: cpp
          :fragment: [include]
    ...
    .. tab-item:: C
       ...
       .. doxygensnippet:: docs/articles_en/assets/snippets/src/main.c
          :language: cpp
          :fragment: [include]
